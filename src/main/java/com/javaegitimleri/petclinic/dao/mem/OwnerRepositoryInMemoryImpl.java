...
public class OwnerRepositoryInMemoryImpl implements OwnerRepository {
    ...
    public OwnerRepositoryInMemoryImpl() {
        ...
        owner1.setId(1L);
        owner1.setFirstName("Metin");
        owner1.setLastName("Kalinsaz");

        Owner owner2 = new Owner();
        owner2.setId(2L);
        owner2.setFirstName("İsa");
        owner2.setLastName("Kalinsaz");

        Owner owner3 = new Owner();
        owner3.setId(3L);
        owner3.setFirstName("Emre");
        owner3.setLastName("Özçelik");

        Owner owner4 = new Owner();
        owner4.setId(4L);
        owner4.setFirstName("Sercan");
        owner4.setLastName("Bayindir");
